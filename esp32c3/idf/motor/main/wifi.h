 ...
 *         Call from a FreeRTOS task loop -- NOT from an ISR or event handler.
 *         Applies pending TX power step set by the disconnect event handler.
 *         Safe to call every loop iteration; no-op when no sweep is pending.
 */
